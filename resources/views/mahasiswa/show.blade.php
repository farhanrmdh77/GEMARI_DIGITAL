    ...
    <div class="md:col-span-2 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-300 p-6 sm:p-8 flex flex-col gap-8 h-full">
        ...
        <div>
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-xs font-bold px-3 py-1 rounded-full {{ ($mahasiswa->jenis_magang ?? 'Reguler') == 'Berbayar' ? 'bg-amber-100 text-amber-700' : 'bg-blue-100 text-blue-700' }}">{{ $mahasiswa->jenis_magang ?? 'Reguler' }}</span>
            </div>
        ...
        <div class="md:pr-8">
            ...
            <div class="grid grid-cols-1 gap-4 font-inter">
                ...
                @if($mahasiswa->surat_permohonan)
                    <a href="{{ route('dokumen.view', ['path' => $mahasiswa->surat_permohonan]) }}" target="_blank" class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl hover:border-blue-300 hover:shadow-sm hover:bg-white transition-all group cursor-pointer" title="Lihat Dokumen">
                @else
                ...
                @endif
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">{{ $mahasiswa->surat_permohonan ? 'Dokumen PDF' : 'Belum Diupload' }}</p>
                        </div>
                    </div>
                    @if($mahasiswa->surat_permohonan)
                ...
                @if($mahasiswa->laporan_magang)
                    <a href="{{ route('dokumen.view', ['path' => $mahasiswa->laporan_magang]) }}" target="_blank" class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl hover:border-green-300 hover:shadow-sm hover:bg-white transition-all group cursor-pointer" title="Lihat Dokumen">
                @else
                    <div class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl transition-all opacity-75">
                @endif
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">{{ $mahasiswa->laporan_magang ? 'Dokumen PDF' : 'Belum Diupload' }}</p>
                        </div>
                    </div>
                    @if($mahasiswa->laporan_magang)
