...
<div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
    ...
    <div class="relative w-full md:w-72 shrink-0">
        ...
        <input type="text" id="searchInput" class="block w-full pl-9 pr-3 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-800 placeholder-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/40 outline-none transition-all font-inter shadow-sm" placeholder="Cari nama atau NIM...">
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8" id="cardContainer">
    ...
    @forelse($mahasiswa as $mhs)
        ...
        <div class="data-card bg-white rounded-[16px] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100 flex flex-col group" 
             ...
             data-instansi="{{ strtolower($mhs->asal_kampus) }}"
             data-jenismagang="{{ strtolower($mhs->jenis_magang ?? 'reguler') }}">
            ...
            <div class="p-6 flex gap-6">
                ...
                <div class="flex-1 min-w-0 py-1">
                    ...
                    <div class="flex items-center gap-2 mb-1">
                        <div class="text-xs font-inter text-slate-500">NIM: <span class="text-slate-800 font-medium">{{ $mhs->nim }}</span></div>
                        <span class="text-[10px] font-bold px-2 py-0.5 rounded-full {{ ($mhs->jenis_magang ?? 'Reguler') == 'Berbayar' ? 'bg-amber-100 text-amber-700' : 'bg-blue-100 text-blue-700' }}">{{ $mhs->jenis_magang ?? 'Reguler' }}</span>
                    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function filterData() {
            ...
            const jenisMagangValue = document.getElementById('jenisMagangFilter').value;
            let visibleCount = 0;
        ...
        document.getElementById('jenisMagangFilter').addEventListener('change', filterData);
    });
</script>
@endsection