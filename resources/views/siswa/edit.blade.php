                    ...
                    <div>
                        ...
                        <select name="asal_sekolah" class="searchable-select w-full bg-white border border-slate-200 rounded-lg px-4 py-2.5 text-sm text-slate-800 focus:border-primary focus:ring-2 focus:ring-primary/40 outline-none transition-all cursor-pointer" required>
                            ...
                            @foreach($instansis as $instansi)
                                <option value="{{ $instansi->nama_instansi }}" {{ old('asal_sekolah', $siswa->asal_sekolah) == $instansi->nama_instansi ? 'selected' : '' }}>{{ $instansi->nama_instansi }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="sm:col-span-2 mt-2">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <label class="relative cursor-pointer block">
                                <input type="radio" name="jenis_magang" value="Reguler" class="peer sr-only" required {{ old('jenis_magang', $siswa->jenis_magang ?? 'Reguler') == 'Reguler' ? 'checked' : '' }}>
                            ...
                            <label class="relative cursor-pointer block">
                                <input type="radio" name="jenis_magang" value="Berbayar" class="peer sr-only" required {{ old('jenis_magang', $siswa->jenis_magang ?? '') == 'Berbayar' ? 'checked' : '' }}>
                                <div class="absolute inset-0 border-2 border-slate-200 rounded-xl transition-all peer-checked:border-primary peer-checked:bg-primary/5 peer-hover:border-slate-300 pointer-events-none"></div>
                                <div class="relative p-4 flex items-center pointer-events-none z-10">
                                    <div class="flex-1 pr-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-slate-100 pt-8 mt-4">
                <div>
                    ...
                    @if($siswa->surat_permohonan)
                        <div class="mb-3 flex items-center justify-between p-3 bg-primary/5 border border-primary/20 rounded-lg">
                            <a href="{{ route('dokumen.view', ['path' => $siswa->surat_permohonan]) }}" target="_blank" class="text-xs font-medium text-primary hover:underline flex items-center gap-2">
                ...
                <div>
                    ...
                    @if($siswa->laporan_magang)
                        <div class="mb-3 flex items-center justify-between p-3 bg-primary/5 border border-primary/20 rounded-lg">
                            <a href="{{ route('dokumen.view', ['path' => $siswa->laporan_magang]) }}" target="_blank" class="text-xs font-medium text-primary hover:underline flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                Lihat File Tersimpan
                            </a>
                            <div class="flex items-center gap-2">
